...
if __name__ == '__main__':
    ...
    os.chdir(u"/Users/zhangjintao/Desktop/ceshi")
    # 将要转换的词库添加在这里就可以了u
    o = [u'/Users/zhangjintao/Desktop/喜马拉雅爬虫/搜狗城市词库/词库/深圳市城市信息精选.scel', ]
    # o = os.listdir("/Users/zhangjintao/Desktop/喜马拉雅爬虫/搜狗城市词库/词库")
    print(o)
    for a in o:
        deal(a)
    # 保存结果
    f = open('最详细的全国地名大全.txt', 'w')
    for word in GTable:
